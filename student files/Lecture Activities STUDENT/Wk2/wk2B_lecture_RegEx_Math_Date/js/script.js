...
/*
	...
	Reminder:  	Day 6 - Midterm Practical
				Day 11 - Final Practical 
*/
...
// STUDENT - how would you write the above with string in the key?
...
//STUDENT - how would you get the birthday month?


// Object witin an object, Arrays, Function
var thatGuy = {
	name: 'JamesBond',
	course: 'PWA1',
	address: {
...
//STUDENT - How would you call the "showMyAddress" function using dot syntax?


// show street address and city.


// shows an array of objects, inside of an object length
var obj1 = {
...
//student is just an array of objects
//STUDENT - how would you get the lenght of the array students?
...
//STUDENT - how would I capture all the 'li' for nav?
...
STUDENT ACTIVITY
	...
	1.  Write a for loop to change all the buttons to "Click Me #"

	2.  The # above is the number of the link starting with 1.

	3.  The # number should be created dynamically using the for loop index number.
...
/*
	...
	Showed how to write an event in the last lecture, like the below:
...
console.log('------------ DOM Events -------------------');
	...
	// need to comment out lines 236 from above - to not remove links.

	var navLinks = document.querySelector('#nav a');  //will just select the first anchor link
...
STUDENT ACTIVITY
	...
	1.  Write a RegEx for a basic name (contain only letters)
