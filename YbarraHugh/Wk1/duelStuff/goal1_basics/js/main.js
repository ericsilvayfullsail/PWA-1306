...
console.log('------ variables ----------');
	...
	var name = "Hugo", course = "PWA1", month = 3;
...
console.log('------ strings ----------');
    ...
    var phrase ="He\'s in PWA1"; // This is the proper way of escaping shit 
    // have to make sure you escape everything properly or it will break err thing. 
    // Double quotes would be  a great example of when this would break \
...
//     var counter = 10 console.log("basic math: ", counter + 1);
 ...
 ********************************************/
	var bestArray = [10, 50, 100, 200];
	var tempHolder = 0;
	for (var i = 0; i < bestArray.length; i++)
	{
		
		tempHolder += bestArray[i];
	}
 ...
 ********************************************/
	...
	someArray[0] = "basketball";
	someArray[1] = "football";
	someArray[2] = "base";
	someArray.push("test");
	console.log(someArray[3]);	// so push works.. nice 
...
var weather = "sunny";
var temp = 60;
var studnet1  = (weather = "sunny" ? "happy" : ((temp >= 80) ? "content" : "sad" ));
console.log ("nested ternay weather : ", studnet1)
