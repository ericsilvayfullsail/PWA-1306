...
// this is integrating multiple data types - object with an array of objects
       ...
       studentCount: 25000,
       students: [
            {name: 'JimmyDean', GPA: 3.5, classes:['Flex','PWA1']},
            {name: 'Sally', GPA: 2.5},
            {name: 'Jack', GPA: 4.0}
       ]
       }
    ...
    console.log('James Bonds GPA: ', object.students[2].GPA);
    console.log('James Bond GPA: ', object['students'][2]['GPA']);
...
----------------------------------------------------------------------------- */
     var gradeAvg = function(a){
         var count = 0;
         var total = 0;

             for(var i = 0; i < object.students.length; i++ ){
                  count++;
                 total = total + a.students[i]['GPA'];''
             }
         return total/count;
      }

     console.log('Average GPA: ', gradeAvg(object));
/*
...
*/
   var students = {name: 'James Bond', gender: 'Male', job: 'MI6'};
...
console.log('------ objects - converting datatypes ----------');
    ...
    var myNum = 1;
    myString = String(myNum); // return the string "1"
...
*/
        ...
        for(i=0;i<navLinks.length;i++){
            ...
            console.log('Manipulating HREF: ',href) ;

            var aClass = navLinks[i].firstChild.getAttribute('class');
            console.log('Manipulating Class: ', aClass)
        }
...
console.log('------------ Manipulating CSS Classes -------------------');
     ...
     var changesClass = navLinks[2].firstChild.setAttribute('href', 'http://google.com');
...
*/
    ...
    navLinks[2].innerHTML = 'This shit is stupid';
