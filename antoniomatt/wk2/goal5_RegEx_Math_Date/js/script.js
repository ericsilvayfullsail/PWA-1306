...
console.log("The length og the students array: " + obj1.students.length);
...
*/
console.log(document.querySelector("#nav li").lastChild);
...
for (var i = 0, max = navLinks.length; i < max; i++) {
	navLinks[i].innerHTML = "Click Me" + 1;
};
...
for (var i = 0, max = navLinks.length; i < max; i++) {
	...
	navLinks[i].style.border = "3px dotted #000";
};
...
var str = "My personal email is mantonio@fullsail.edu";
