...
//Contains all the script that runs immediately when the page is launched
(function(){
...
console.log('------Recap Functions ----------');
    ...
    //	1.  BASIC FUNCTION:
    //Can be called anywhere in the script
    /*var myCtr = 1;
    function myCounter() {
    	myCtr++;
    ...
    //Has to be called after the function
    var myCtr = 1;
...
//console.log(document.write(str1.toLowerCase()));
...
********************************************/
    ...
    console.log(nameArray.splice(0, 3));
    console.log(nameArray.push("NEW VALUE"));
